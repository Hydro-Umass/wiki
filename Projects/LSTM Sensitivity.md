...
First follow the instructions at [Unity/Runing%20uv-based%20Python%20projects.md](Running uv-based Python projects) to set up the `uv` environment and the source code. 
